...
/**
 * A classe ManipuladorArquivo realiza as operações de leitura e escrita
...
public class ManipuladorArquivo {
    ...
    /**
     * Retorna o arquivo .txt inteiro em formato String. É necessario receber o
     * caminho relativo ou absoluto do arquivo de texto a ser lido.
     *
    ...
    /**
     * A função realiza a gravação de uma string num arquivo de texto cujo
     * caminho será informado. Também é necessário informar o caminho relativo
     * ou absoluto do novo arquivo a ser criado. Caso já exista um arquivo
     * naquele caminho, o existente será sobrescrevido.
     *
